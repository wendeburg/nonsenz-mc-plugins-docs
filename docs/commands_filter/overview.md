...
- **Group Inheritance** — In whitelist mode, higher-priority groups automatically inherit all commands visible to lower-priority groups. See [Configuration](configuration.md).
